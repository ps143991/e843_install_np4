...
45 &  zero extrapolation too high:548.916channels;  \\ \hline 
\end{tabular} 
\end{center}
\begin{figure}[htcb!]
\begin{center}
\includegraphics[width=0.7\textwidth]{./Calibration/MUGAST@LISE23_run_7_pedestals_X_MM3_E/latex/pictures/Telescope3Summary.pdf}
\end{center}
\end{figure}
\pagebreak
Sigma fit centroid: 2.65462

Sigma fit sigma: 0.208259
