...
14 &  zero extrapolation too high:45.6716channels;  \\ \hline 
15 &  zero extrapolation too high:40.9418channels;  \\ \hline 
16 &  zero extrapolation too high:38.947channels;  \\ \hline 
\end{tabular} 
\end{center}
\begin{figure}[htcb!]
\begin{center}
\includegraphics[width=0.7\textwidth]{./Calibration/MUGAST_LISE23_run_175_X_MM2_E/latex/pictures/Telescope2Summary.pdf}
\end{center}
\end{figure}
\pagebreak
Sigma fit centroid: 2.1196

Sigma fit sigma: 0.11347
