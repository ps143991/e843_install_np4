...
22 &  2 peak(s) found; zero extrapolation too high:8203.4channels;  \\ \hline 
\end{tabular} 
\end{center}
\begin{figure}[htcb!]
\begin{center}
\includegraphics[width=0.7\textwidth]{./Calibration/MUGAST_LISE23_run_9_X_MM1_E/latex/pictures/Telescope1Summary.pdf}
\end{center}
\end{figure}
\pagebreak
Sigma fit centroid: 2.16105

Sigma fit sigma: 0.156753
