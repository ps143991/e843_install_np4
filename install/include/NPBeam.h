...
namespace nptool {
  class Beam : public nptool::Particle {
   ...
   public:
    // Getters and Setters
    // Set
    // void SetBeamParticle (Particle* BeamParticle)  {delete fBeamParticle ;
    // fBeamParticle = new Particle(BeamParticle->GetZ(),BeamParticle->GetA());}
    ...
    void SetEnergyHist(TH1F* EnergyHist) {
      delete fEnergyHist;
      fEnergyHist = EnergyHist;
    }
    void SetXThetaXHist(TH2F* XThetaXHist) {
      delete fXThetaXHist;
      fXThetaXHist = XThetaXHist;
    }
    void SetYPhiYHist(TH2F* YPhiYHist) {
      delete fYPhiYHist;
      fYPhiYHist = YPhiYHist;
    }
