...
private:
    ...
    TH2F *h2dPL = new TH2F("h2dPL", "Beam Spot in PL from Data", 2400, -11, 11, 7, 0, 7);
    TH2F *Trajectory_XZ = new TH2F("Trajectory_XZ", "X vs Z", 370, 6000, 9700, 200, -100, 100);
    TH2F *Trajectory_YZ = new TH2F("Trajectory_YZ", "Y vs Z", 370, 6000, 9700, 200, -100, 100);
    TH2F *PL_spot_const = new TH2F("PL_spot_const", "Extrapolated Beam Spot in PL", 200,-100,100,200,-100,100);
    TH2F *CATS2Y_CATS2X = new TH2F("CATS2Y_CATS2X", "CATS_2 Y:X",600,-30,30,600,-30,30);
    TH2F *CATS1Y_CATS1X = new TH2F("CATS1Y_CATS1X", "CATS_1 Y:X",600,-30,30,600,-30,30);
    TH2F *MASK2Y_MASK2X = new TH2F("MASK2Y_MASK2X", "MASK_2 Y:X",600,-30,30,600,-30,30);
    TH2F *MASK1Y_MASK1X = new TH2F("MASK1Y_MASK1X", "MASK_1 Y:X",600,-30,30,600,-30,30);
    ...
    Double_t perbin_value[5]= {346.20000, 324.30000, 297.30000, 322.20000, 368.40000};
    Double_t x_value[5];
    Double_t Position[6]={6035.5,6532.5,8758.5,9008.5,9178.5,9678.5}; 
                          //cats 1, cats2, DC1, DC2, IC1, PLastics
    
    Double_t slopeCATSx, slopeCATSy;
    int countPS_bcats;
    double  IC_ZDD_sum;
    bool TAC_TOF;
