...
private:
   ...
   std::vector<unsigned int> TAC_CATSD6_1_DD4;
    ...
    std::vector<double> PL_E1;
    std::vector<double> PL_E2;
    std::vector<double> PL_E3;
    std::vector<double> PL_E4;
    std::vector<double> PL_E5;
    std::vector<double> PL_E6;
    std::vector<double> PL_E7;
    std::vector<double> PL_E8;
    std::vector<double> PL_E9;
    std::vector<double> PL_E10;
    std::vector<double> IC_1;
    std::vector<double> IC_2;
    std::vector<double> IC_3;
    std::vector<double> IC_4;
    std::vector<double> IC_5;
