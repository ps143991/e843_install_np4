...
std::shared_ptr<MaterialManager> MaterialManager::m_instance = nullptr;

////////////////////////////////////////////////////////////////////////////////
std::shared_ptr<MaterialManager> MaterialManager::GetMaterialManager() {
  if (!m_instance) {
    m_instance = std::make_shared<MaterialManager>();
  }
...
////////////////////////////////////////////////////////////////////////////////
G4Material* MaterialManager::GetMaterialFromLibrary(std::string Name, double density) {
  ...
  if (it == m_Material.end()) {
    ...
    // Misc
      ...
      message("green", "Geant4", "MaterialManager", "getting material from NIST");
...
void MaterialManager::WriteDEDXTable(G4ParticleDefinition* Particle, G4double Emin, G4double Emax) {
  ...
  for (it = m_Material.begin(); it != m_Material.end(); it++) {
    ...
    G4String GlobalPath = nptool::Application::GetApplication()->GetEnergyLossPath();
...
////////////////////////////////////////////////////////////////////////////////
//   Generate Cross Section table using the material used in the geometry
