...
public:
  ...
  InteractionData(const unsigned int& Index, const double& Energy,
  ...
  InteractionData(const unsigned int& Index, const double& Energy,
                  ...
                  const double& PositionY, const double& PositionZ,
                  const double& Theta, const double& Phi,
                  const std::string& ParticleName, const int& A, const int& Z,
                  const double& Mass, const int& Charge, const double& Brho,
...
public:
  ...
  void Add(const unsigned int& index, const double& Energy) {
    find(index)->Add(Energy);
  };
  ...
  void Set(const unsigned int& index, const double& Energy, const double& Time,
    ...
    m_Data.push_back(InteractionData(index, Energy, Time, PositionX, PositionY,
                                     PositionZ, Theta, Phi));
  };
  ...
  void Set(const unsigned int& index, const double& Energy, const double& Time,
           ...
           const double& KineticEnergy) {
    m_Data.push_back(InteractionData(index, Energy, Time, PositionX, PositionY,
                                     PositionZ, Theta, Phi, ParticleName, A, Z,
                                     Mass, Charge, Brho, KineticEnergy));
  };
...
public: // with description
  PS_Interactions(G4String name, InteractionCoordinates* Inter,
                  G4int depth = 0);
  ~PS_Interactions() {};
...
private:
  ...
  InteractionCoordinates* m_InterractionCoordinates;
...
public:
  ...
  inline double       GetEnergy(const unsigned int& i) {
    return m_DataVector[i]->GetEnergy();
  };
  inline double GetKineticEnergy(const unsigned int& i) {
    return m_DataVector[i]->GetKineticEnergy();
  };
  inline double GetBrho(const unsigned int& i) {
    return m_DataVector[i]->GetBrho();
  };
  inline double GetPositionX(const unsigned int& i) {
    return m_DataVector[i]->GetPositionX();
  };
  inline double GetPositionY(const unsigned int& i) {
    return m_DataVector[i]->GetPositionY();
  };
  inline double GetPositionZ(const unsigned int& i) {
    return m_DataVector[i]->GetPositionZ();
  };
  inline double GetCharge(const unsigned int& i) {
    return m_DataVector[i]->GetCharge();
  };
  inline double GetTheta(const unsigned int& i) {
    return m_DataVector[i]->GetTheta();
  };
  inline double GetPhi(const unsigned int& i) {
    return m_DataVector[i]->GetPhi();
  };
};
