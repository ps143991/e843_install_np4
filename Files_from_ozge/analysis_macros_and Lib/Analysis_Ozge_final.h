...
private:
   ...
   // std::vector<double> MG_Exnocor;
    ...
    std::vector<string> light_particles{"proton"};
    double Si_E_d;
    double CsI_E_d;
    ...
    //DC
    float Position[3]={6035.5,6532.5,8883.5};
    float ax[2],ay[2];
    double dx_C1_DC;
    double dy_C1_DC;
    int ix;
   ...
   NPL::Reaction* reaction2 = new Reaction;
