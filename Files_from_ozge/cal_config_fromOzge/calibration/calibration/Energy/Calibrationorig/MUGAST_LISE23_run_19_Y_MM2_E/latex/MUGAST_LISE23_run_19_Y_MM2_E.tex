...
123 &  zero extrapolation too high:177.726channels;  \\ \hline 
\end{tabular} 
\end{center}
\begin{figure}[htcb!]
\begin{center}
\includegraphics[width=0.7\textwidth]{./Calibration/MUGAST_LISE23_run_19_Y_MM2_E/latex/pictures/Telescope2Summary.pdf}
\end{center}
\end{figure}
\pagebreak
Sigma fit centroid: 2.18349

Sigma fit sigma: 0.157265
