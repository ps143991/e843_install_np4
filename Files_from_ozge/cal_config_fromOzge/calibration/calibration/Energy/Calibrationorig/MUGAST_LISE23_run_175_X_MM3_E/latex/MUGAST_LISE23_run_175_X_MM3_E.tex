...
45 &  1 peak(s) found; zero extrapolation too high:8203.4channels;  \\ \hline 
48 &  0 peak(s) found; zero extrapolation too high:8203.4channels;  \\ \hline 
\end{tabular} 
\end{center}
\begin{figure}[htcb!]
\begin{center}
\includegraphics[width=0.7\textwidth]{./Calibration/MUGAST_LISE23_run_175_X_MM3_E/latex/pictures/Telescope3Summary.pdf}
\end{center}
\end{figure}
\pagebreak
Sigma fit centroid: 1.37605

Sigma fit sigma: 1.55787
