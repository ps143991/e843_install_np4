...
14 &  zero extrapolation too high:35.986channels;  \\ \hline 
15 &  zero extrapolation too high:37.0181channels;  \\ \hline 
16 &  zero extrapolation too high:33.6267channels;  \\ \hline 
44 &  0 peak(s) found; zero extrapolation too high:8203.4channels;  \\ \hline 
\end{tabular} 
\end{center}
\begin{figure}[htcb!]
\begin{center}
\includegraphics[width=0.7\textwidth]{./Calibration/MUGAST_LISE23_run_9_X_MM2_E/latex/pictures/Telescope2Summary.pdf}
\end{center}
\end{figure}
\pagebreak
Sigma fit centroid: 2.39755

Sigma fit sigma: 0.130035
