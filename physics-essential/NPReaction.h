...
namespace nptool {
  ...
  class Reaction {
   ...
   public: // Various Method
    nptool::Particle GetParticle(string name, nptool::InputParser parser);
   ...
   private:
    nptool::Beam fParticle1;                   // Beam
    nptool::Particle fParticle2;               // Target
    nptool::Particle fParticle3;               // Light ejectile
    nptool::Particle fParticle4;               // Heavy ejectile
   ...
   public:
    ...
    nptool::Particle* GetParticle1() { return &fParticle1; }
    nptool::Particle* GetParticle2() { return &fParticle2; }
    nptool::Particle* GetParticle3() { return &fParticle3; }
    nptool::Particle* GetParticle4() { return &fParticle4; }
    nptool::Particle* GetNucleus1() { return GetParticle1(); }
    nptool::Particle* GetNucleus2() { return GetParticle2(); }
    nptool::Particle* GetNucleus3() { return GetParticle3(); }
    nptool::Particle* GetNucleus4() { return GetParticle4(); }
   ...
   public: // Kinematics
    ...
    TGraph* GetJacobian(double AngleStep_CM = 1);
    void PrintKinematic();
