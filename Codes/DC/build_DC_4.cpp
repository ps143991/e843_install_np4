            ...
            if(phy_cats_r->PositionOnTargetY > -200 && phy_cats_r->PositionOnTargetX > -200){
              ...
              if(phy_zdd_r->PL_E.size()>0){
                ...
                if(TS_sub3_adj>=(-10) || TS_sub4_adj>=(-10)){   //excluding noise
                  ...
                  // the 4 quadrants
                  if(dc3_flag && dc2_flag){dc_spot->Fill(  TS_sub3_adj*DC_plane_coeff[1][0] + DC_plane_coeff[1][1],    TS_sub2_adj*DC_plane_coeff[0][0] + DC_plane_coeff[0][1]);
                  // cout<<"(x,y) is: ("<<TS_sub3_adj*DC_plane_coeff[1][0] + DC_plane_coeff[1][1]<<","<<  TS_sub2_adj*DC_plane_coeff[0][0] + DC_plane_coeff[0][1]<<")"<<endl;
                  }  //quad 1
                  if(dc4_flag && dc2_flag){dc_spot->Fill(-(TS_sub4_adj*DC_plane_coeff[1][0] + DC_plane_coeff[1][1]),   TS_sub2_adj*DC_plane_coeff[0][0] + DC_plane_coeff[0][1]);
                  // cout<<"(x,y) is: ("<<-(TS_sub4_adj*DC_plane_coeff[1][0] + DC_plane_coeff[1][1])<<","<<  TS_sub2_adj*DC_plane_coeff[0][0] + DC_plane_coeff[0][1]<<")"<<endl;
                  }  //quad 2
                  if(dc4_flag && dc1_flag){dc_spot->Fill(-(TS_sub4_adj*DC_plane_coeff[1][0] + DC_plane_coeff[1][1]), -(TS_sub1_adj*DC_plane_coeff[0][0] + DC_plane_coeff[0][1]));
                  // cout<<"(x,y) is: ("<<-(TS_sub4_adj*DC_plane_coeff[1][0] + DC_plane_coeff[1][1])<<","<<  -(TS_sub1_adj*DC_plane_coeff[0][0] + DC_plane_coeff[0][1])<<")"<<endl;
                  }  //quad 3
                  if(dc3_flag && dc1_flag){dc_spot->Fill(  TS_sub3_adj*DC_plane_coeff[1][0] + DC_plane_coeff[1][1],  -(TS_sub1_adj*DC_plane_coeff[0][0] + DC_plane_coeff[0][1]));
                  // cout<<"(x,y) is: ("<<TS_sub3_adj*DC_plane_coeff[1][0] + DC_plane_coeff[1][1]<<","<<   -(TS_sub1_adj*DC_plane_coeff[0][0] + DC_plane_coeff[0][1])<<")"<<endl;
                  }  //quad 4
