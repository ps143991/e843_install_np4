...
TGraph *DIS[12] = {DIS1, DIS2, DIS3, DIS4, DIS5, DIS6, DIS7, DIS8, DIS9, DIS10, DIS11, DIS12};


Double_t angles[5] = {119.5, 128.5, 137.5, 146.5, 155.5}; // middle of each angular bin
Double_t integrals[12][5] = {0}; // 5 angular bins, 12 peaks (6 simulated, 6 new)
...
void DrawAngularDistribution() {
  ...
  DIS[0]->SetLineColor(kRed);
  DIS[1]->SetLineColor(kBlue);
  DIS[2]->SetLineColor(kGreen);
  DIS[3]->SetLineColor(kMagenta);
  DIS[4]->SetLineColor(kCyan);
  DIS[5]->SetLineColor(kOrange);
  DIS[6]->SetLineColor(kViolet);
  DIS[7]->SetLineColor(kPink);
  DIS[8]->SetLineColor(kGray+1);
  DIS[9]->SetLineColor(kTeal);
  DIS[10]->SetLineColor(kBlack);
  DIS[11]->SetLineColor(kSpring+7);
  ...
  for(int i = 0; i < 12; ++i){leg->AddEntry(DIS[i], Form("Peak %d", i+1), "lp");}
  leg->Draw();
}
...
/*     TF1* bglandau = new TF1("bglandau", [](double* x, double* par) {
    ...
    peak4gfit->Draw("same");
        ...
        TF1* peak5gfit = new TF1(Form("%.3f",whole->GetParameter(18)), gaus_plus_pol4, 1.8, 3.8, 8);    //2.8
    ...
    peak5gfit->Draw("same");
        ...
        TF1* peak6gfit = new TF1(Form("%.3f",whole->GetParameter(21)), gaus_plus_pol4, 3.0, 5.0, 8);  //4.0
    ...
    peak6gfit->Draw("same");
          ...
          TF1* peak7gfit = new TF1(Form("%.3f",whole->GetParameter(24)), gaus_plus_pol4, 2.3, 4.3, 8);  //3.3
    ...
    peak7gfit->Draw("same");
          ...
          TF1* peak8gfit = new TF1(Form("%.3f",whole->GetParameter(27)), gaus_plus_pol4, 0.5, 2.5, 8);  //1.5
    ...
    peak8gfit->Draw("same");
            ...
            TF1* peak9gfit = new TF1(Form("%.3f",whole->GetParameter(30)), gaus_plus_pol4, 2.8, 4.8, 8); //3.8
    ...
    peak9gfit->Draw("same");
            ...
            TF1* peak10gfit = new TF1(Form("%.3f",whole->GetParameter(33)), gaus_plus_pol4, 3.8, 5.2, 8);   //4.9
    ...
    peak10gfit->Draw("same");
            ...
            TF1* peak11gfit = new TF1(Form("%.3f",whole->GetParameter(36)), gaus_plus_pol4, 1.3, 3.3, 8); //2.3  
    peak11gfit->SetParameters(whole->GetParameter(35), whole->GetParameter(36), whole->GetParameter(37),
        whole->GetParameter(0), whole->GetParameter(1), whole->GetParameter(2), whole->GetParameter(3), whole->GetParameter(4));
    peak11gfit->SetLineColor(kTeal + 2);
    peak11gfit->SetFillColor(kTeal + 2);
    peak11gfit->SetFillStyle(0); // No fill, just line
    peak11gfit->Draw("same");


            TF1* peak12gfit = new TF1(Form("%.3f",whole->GetParameter(39)), gaus_plus_pol4, 3.5, 5.2, 8);   //4.5
    peak12gfit->SetParameters(whole->GetParameter(38), whole->GetParameter(39), whole->GetParameter(40),
        whole->GetParameter(0), whole->GetParameter(1), whole->GetParameter(2), whole->GetParameter(3), whole->GetParameter(4));    
    peak12gfit->SetLineColor(kSpring + 8);
    peak12gfit->SetFillColor(kSpring + 8);
    peak12gfit->SetFillStyle(0); // No fill, just line
    peak12gfit->Draw("same");
        ...
        //   legend->AddEntry((TObject*)nullptr, Form("ThetaLab: %d °", (angmin + angmax)/2), "");
          ...
          legend->AddEntry(peak8gfit,  Form("%.3f; %.2f",whole->GetParameter(27), whole->GetParameter(27+1)), "l");         //1.5
          legend->AddEntry(peak3gfit,  Form("%.3f; %.2f",whole->GetParameter(12), whole->GetParameter(12+1)), "l");         //1.8
          legend->AddEntry(peak11gfit, Form("%.3f; %.2f",whole->GetParameter(36), whole->GetParameter(36+1)), "l");         //2.3
          ...
          legend->AddEntry(peak7gfit,  Form("%.3f; %.2f",whole->GetParameter(24), whole->GetParameter(24+1)), "l");         //3.3
          legend->AddEntry(peak9gfit,  Form("%.3f; %.2f",whole->GetParameter(30), whole->GetParameter(30+1)), "l");         //3.8
          legend->AddEntry(peak6gfit,  Form("%.3f; %.2f",whole->GetParameter(21), whole->GetParameter(21+1)), "l");         //4.0
          legend->AddEntry(peak12gfit, Form("%.3f; %.2f",whole->GetParameter(39), whole->GetParameter(39+1)), "l");         //4.5
          legend->AddEntry(peak10gfit, Form("%.3f; %.2f",whole->GetParameter(33), whole->GetParameter(33+1)), "l");         //4.9
 ...
 /*        c3->SaveAs(Form("pdf/exfit_ang%dto%d.pdf", angmin, angmax));
    ...
    double I1465 = peak8gfit->Integral( whole->GetParameter(27) - 3*whole->GetParameter(28), whole->GetParameter(27) + 3*whole->GetParameter(28)) 
    ...
    double I2270 = peak11gfit->Integral( whole->GetParameter(36) - 3*whole->GetParameter(37), whole->GetParameter(36) + 3*whole->GetParameter(37)) 
                                    - bc_pol4->Integral(whole->GetParameter(36) - 3*whole->GetParameter(37), whole->GetParameter(36) + 3*whole->GetParameter(37)) ;                                                                                                       
    ...
    double I3259 = peak7gfit->Integral( whole->GetParameter(24) - 3*whole->GetParameter(25), whole->GetParameter(24) + 3*whole->GetParameter(25)) 
                                    - bc_pol4->Integral(whole->GetParameter(24) - 3*whole->GetParameter(25), whole->GetParameter(24) + 3*whole->GetParameter(25)) ;
    double I3780 = peak9gfit->Integral( whole->GetParameter(30) - 3*whole->GetParameter(31), whole->GetParameter(30) + 3*whole->GetParameter(31)) 
                                    - bc_pol4->Integral(whole->GetParameter(30) - 3*whole->GetParameter(31), whole->GetParameter(30) + 3*whole->GetParameter(31)) ;
    double I4067 = peak6gfit->Integral( whole->GetParameter(21) - 3*whole->GetParameter(22), whole->GetParameter(21) + 3*whole->GetParameter(22)) 
                                    - bc_pol4->Integral(whole->GetParameter(21) - 3*whole->GetParameter(22), whole->GetParameter(21) + 3*whole->GetParameter(22)) ;
    double I4462 = peak12gfit->Integral( whole->GetParameter(39) - 3*whole->GetParameter(40), whole->GetParameter(39) + 3*whole->GetParameter(40)) 
                                    - bc_pol4->Integral(whole->GetParameter(39) - 3*whole->GetParameter(40), whole->GetParameter(39) + 3*whole->GetParameter(40)) ;
    double I4934 = peak10gfit->Integral( whole->GetParameter(33) - 3*whole->GetParameter(34), whole->GetParameter(33) + 3*whole->GetParameter(34)) 
                                    - bc_pol4->Integral(whole->GetParameter(33) - 3*whole->GetParameter(34), whole->GetParameter(33) + 3*whole->GetParameter(34)) ;
    ...
    cout<< "Integral of peak 4067: " << I4067*10 << endl;
    cout<<"************************************************"<<endl;

    if(selection == 1 && reps >= 0){
        integrals[0] [reps]= I1*10;
        integrals[1] [reps]= I915*10;
        integrals[2] [reps]= I1465*10;
        integrals[3] [reps]= I1860*10;
        integrals[4] [reps]= I2270*10;
        integrals[5] [reps]= I2560*10;
        integrals[6] [reps]= I2860*10;
        integrals[7] [reps]= I3259*10;
        integrals[8] [reps]= I3780*10;
        integrals[9] [reps]= I4067*10;
        integrals[10][reps] = I4462*10;
        integrals[11][reps] = I4934*10;
    }
    for (int i = 0; i < 12; ++i) {
...
using namespace std;
void response_fitPS_v11_successful_still()
{
    ...
    Int_t totalparams = 5 + (3*6) + (3*6); // 5 for pol4, 6 simulated gaus, 2 new gaus
...
for (int i = 0; i < 5; ++i) {
    ...
    for(int li = 5; li < 23; ++li) {
        ...
        whole->SetParLimits(5,  1,200);   whole->SetParLimits(6,  0.0 -0.01, 0.0 +0.01);   whole->SetParLimits(7, 0.15, 0.30);
        whole->SetParLimits(8,  1,200);   whole->SetParLimits(9,  0.915 -0.01, 0.915 + 0.01);   whole->SetParLimits(10,0.15, 0.25);
        whole->SetParLimits(11, 1,200);   whole->SetParLimits(12, fit_parameters[12]-0.01, fit_parameters[12] +0.01);  whole->SetParLimits(13,0.15, 0.25);
        whole->SetParLimits(14, 1,200);   whole->SetParLimits(15, 2.53, 2.57);  whole->SetParLimits(16,0.15, 0.25);
        whole->SetParLimits(17, 1,200);   whole->SetParLimits(18, 2.86, 2.9);  whole->SetParLimits(19,0.15, 0.25);
        whole->SetParLimits(20, 1,200);   whole->SetParLimits(21, fit_parameters[21]-0.01, fit_parameters[21] +0.01);  whole->SetParLimits(22,0.15, 0.25);
        ...
        whole->SetParameter(23, 10); whole->SetParameter(24, 3.3); whole->SetParameter(25, 0.25);
        whole->SetParLimits(23, 1,200); whole->SetParLimits(24, 3.3-0.2, 3.3+0.2); whole->SetParLimits(25, 0.15,0.25);

        whole->SetParameter(26, 10); whole->SetParameter(27, 1.5); whole->SetParameter(28, 0.25);
        whole->SetParLimits(26, 1,200); whole->SetParLimits(27, 1.5-0.2, 1.5+0.2); whole->SetParLimits(28, 0.15,0.25);

        whole->SetParameter(29, 10); whole->SetParameter(30, 3.8); whole->SetParameter(31, 0.25);
        whole->SetParLimits(29, 1,200); whole->SetParLimits(30, 3.8-0.02, 3.8+0.02); whole->SetParLimits(31, 0.15,0.25);

        whole->SetParameter(32, 10); whole->SetParameter(33, 4.8); whole->SetParameter(34, 0.25);
        whole->SetParLimits(32, 1,200); whole->SetParLimits(33, 4.8-0.3, 4.8+0.3); whole->SetParLimits(34, 0.15,0.25);


        whole->SetParameter(35, 10); whole->SetParameter(36, 2.28); whole->SetParameter(37, 0.25);
        whole->SetParLimits(35, 1,200); whole->SetParLimits(36, 2.28-0.01, 2.28+0.01); whole->SetParLimits(37, 0.15,0.25);

        whole->SetParameter(38, 10); whole->SetParameter(39, 4.27); whole->SetParameter(40, 0.25);
        whole->SetParLimits(38, 1,200); whole->SetParLimits(39, 4.27-0.3, 4.27+0.3); whole->SetParLimits(40, 0.15,0.25);
    ...
    for(int ill = 0; ill < totalparams; ++ill) {
        ...
        whole_region->SetParLimits(5,  1,200);   whole_region->SetParLimits(6,  fit_parameters[6]  -0.005,fit_parameters[6]  + 0.005);  whole_region->SetParLimits(7, 0.15, 0.25);
        whole_region->SetParLimits(8,  1,200);   whole_region->SetParLimits(9,  fit_parameters[9]  -0.005,fit_parameters[9]  + 0.005);  whole_region->SetParLimits(10,fit_parameters[10]-0.02, fit_parameters[10] + 0.02);
        whole_region->SetParLimits(11, 1,200);  whole_region->SetParLimits(12, fit_parameters[12] -0.005,fit_parameters[12] + 0.005);  whole_region->SetParLimits(13,fit_parameters[13]-0.02, fit_parameters[13] + 0.02);
        whole_region->SetParLimits(14, 1,200);  whole_region->SetParLimits(15, fit_parameters[15] -0.005,fit_parameters[15] + 0.005);  whole_region->SetParLimits(16,fit_parameters[16]-0.02, fit_parameters[16] + 0.02);
        whole_region->SetParLimits(17, 1,200);   whole_region->SetParLimits(18, fit_parameters[18] -0.005,fit_parameters[18] + 0.005);  whole_region->SetParLimits(19,fit_parameters[19]-0.02, fit_parameters[19] + 0.02);
        whole_region->SetParLimits(20, 1,200);   whole_region->SetParLimits(21, fit_parameters[21] -0.005,fit_parameters[21] + 0.005);  whole_region->SetParLimits(22,fit_parameters[22]-0.02, fit_parameters[22] + 0.02);
        whole_region->SetParLimits(23, 1,200);   whole_region->SetParLimits(24, fit_parameters[24] -0.005,fit_parameters[24] + 0.005);  whole_region->SetParLimits(25,fit_parameters[25]-0.02, fit_parameters[25] + 0.02);
        whole_region->SetParLimits(26, 1,200);   whole_region->SetParLimits(27, fit_parameters[27] -0.005,fit_parameters[27] + 0.005);  whole_region->SetParLimits(28,fit_parameters[28]-0.02, fit_parameters[28] + 0.02);
        whole_region->SetParLimits(29, 1,200);   whole_region->SetParLimits(30, fit_parameters[30] -0.005,fit_parameters[30] + 0.005);  whole_region->SetParLimits(31,fit_parameters[31]-0.02, fit_parameters[31] + 0.02);
        whole_region->SetParLimits(32, 1,200);   whole_region->SetParLimits(33, fit_parameters[33] -0.005,fit_parameters[33] + 0.005);  whole_region->SetParLimits(34,fit_parameters[34]-0.02, fit_parameters[34] + 0.02);
        whole_region->SetParLimits(35, 1,200);   whole_region->SetParLimits(36, fit_parameters[36] -0.005,fit_parameters[36] + 0.005);  whole_region->SetParLimits(37,fit_parameters[37]-0.02, fit_parameters[37] + 0.02);
        whole_region->SetParLimits(38, 1,200);   whole_region->SetParLimits(39, fit_parameters[39] -0.005,fit_parameters[39] + 0.005);  whole_region->SetParLimits(40,fit_parameters[40]-0.02, fit_parameters[40] + 0.02);
