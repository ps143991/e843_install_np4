...
using namespace std;
void response_fitPS_v8_nothing_special()
{
    ...
    for(int ci = 0; ci < 5; ++ci) {
        ...
        TF1* whole_region = new TF1(Form("whole_region%d", ci+1), allgaus_plus_pol4, -1.5, 5.2, 26);
                for(int ill = 0; ill < 26; ++ill) {
                    ...
                    whole_region->SetParLimits(0, 1, 200);   whole_region->SetParLimits(1,  fit_parameters[1] -0.1,fit_parameters[1]  + 0.01);  whole_region->SetParLimits(2, 0.25, 0.35);
                    whole_region->SetParLimits(3, 1, 200);   whole_region->SetParLimits(4,  fit_parameters[4] -0.1,fit_parameters[4]  + 0.01);  whole_region->SetParLimits(5, 0.25, 0.35);
                    whole_region->SetParLimits(6, 1, 200);   whole_region->SetParLimits(7,  fit_parameters[7] -0.1,fit_parameters[7]  + 0.01);  whole_region->SetParLimits(8, 0.25, 0.35);
                    whole_region->SetParLimits(9, 1, 200);   whole_region->SetParLimits(10, fit_parameters[10]-0.1,fit_parameters[10] + 0.01);  whole_region->SetParLimits(11,0.25, 0.35);
                    whole_region->SetParLimits(12, 1,200);   whole_region->SetParLimits(13, fit_parameters[13]-0.1,fit_parameters[13] + 0.01);  whole_region->SetParLimits(14,0.25, 0.35);
                    whole_region->SetParLimits(15, 1,200);   whole_region->SetParLimits(16, fit_parameters[16]-0.1,fit_parameters[16] + 0.01);  whole_region->SetParLimits(17,0.25, 0.35);
